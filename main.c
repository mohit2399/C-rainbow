...
int main() {
    ...
    printf("topics:\n"
           ...
           "10: type declaration variable\n"
           "11: operators\n"
           "12: type casting\n"
           "13: comments\n"
           "14: function revisited\n"
           "15: at last some main extra points\n\033[0m");
...
void introduction() {
    ...
    printf("\"\\033[1;30m\\033[1;44m\"C is a very powerful and flexible general purpose language that has\n"
...
void operator() {
    printf("\033[0;37m""\033[1;30m\033[1;44m""\n\nOPERATORS"
           ...
           "\n example\na=b+c""\033[0m");
    printf("\n\033[1;30m\033[1;45m types of the variable:\n"
           "1: arithmetic\n"
           "2: assignment\n"
           ...
           "8: ternary\n"
           "9: sizeof\n"
           "please enter the code to check:\n");
    int code;
    scanf("%d", &code);
    switch (code) {
        case 1: {
